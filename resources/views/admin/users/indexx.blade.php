              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
                      ...
                      <span class="required">*</span>
                      {!! Form::select('role', ['S' => 'Student', 'A'=>'Administrator', 'Adder'=>'Adder', 'Editor'=>'Editor'], null, ['class' => 'form-control select2', 'required' => 'required']) !!}
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <div class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
                                  ...
                                  {!! Form::select('role', ['S' => 'Student', 'A'=>'Administrator', 'Adder'=>'Adder', 'Editor'=>'Editor'], null, ['class' => 'form-control select2', 'required' => 'required'], null, ['class' => 'form-control select2', 'required' => 'required']) !!}
                                  <small class="text-danger">{{ $errors->first('role') }}</small>
                              </div>
                            </div>
                            <div class="col-md-6">
