...
<div class="wrapper">
  ...
  <header class="main-header ">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <a href="{{url('/')}}" class="btn visit-btn text-primary" style="color: rgb(46, 158, 238)" target="_blank" title="Visit Site">Visit Site <i class="fa fa-arrow-circle-o-right"></i>{{$auth->name}}</a>
      <!-- Navbar Right Menu -->
      <div class="navbar-custom-menu "  style="background-color: #e3f2fd;">
          ...
          <li class="dropdown">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">
                  ...
                  <img title="{{ $auth->name }}" class="img-circle" width="40px" height="40px "  src="{{ url('images/user/'.Auth::user()->image) }}" alt="">
              @else
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu list-group list-group-flush" data-widget="tree">
        ...
        @if ($auth->role == 'A')
          ...
          <li class="{{$dash}}  list-group-item"><a href="{{url('/admin')}}" title="Dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
          <li class="{{$quiz}} list-group-item"><a href="{{url('admin/topics')}}" title="Quiz"><i class="fa fa-gears"></i> <span>Book Category</span></a></li>          
          <li class="{{$questions}} list-group-item"><a href="{{url('admin/questions')}}" title="Questions"><i class="fa fa-question-circle-o"></i> <span>Books</span></a></li> 
          <li class="{{$questions}} list-group-item"><a href="" title="Questions"><i class="fa fa-question-circle-o"></i> <span>Manage New Books</span></a></li> 
          <li class="{{$users}} list-group-item"><a href="{{url('/admin/users')}}" title="Students"><i class="fa fa-users"></i> <span>Customers</span></a></li>
          <li><a href="{{ route('categories.index') }}"><i class="fas fa-folder"></i>Book Categories</a></li>
          <a href="{{ route('books.index') }}">
            <i class="fas fa-book"></i> Books
        </a>


            {{-- <li class="{{$top_re}} list-group-item"> <a href="{{ route('ads.index') }}">Go to Ads Management</a></li> --}}
            <li class="{{$top_re}} list-group-item"> <a href="{{route('ad-management.index')}}">Go to Ads Management</a></li>
           
          <li class="{{$sett}} list-group-item"><a href="{{url('/admin/settings')}}" title="Settings"><i class="fa fa-gear"></i> <span>Settings</span></a></li>
          

          <li class="treeview {{ Nav::isRoute('pages.index') }} {{ Nav::isRoute('pages.add') }} {{ Nav::isRoute('pages.edit') }} {{ Nav::isRoute('faq.index') }} {{ Nav::isRoute('faq.add') }} {{ Nav::isRoute('faq.edit') }} {{ Nav::isRoute('copyright.index') }} {{ Nav::isRoute('set.facebook') }} {{ Nav::isRoute('customstyle') }} {{ Nav::isRoute('mail.getset') }} {{ Nav::isRoute('socialicons.index')}} list-group-item">
            <a href="#">
            ...
            <ul class="treeview-menu bg-dark">
