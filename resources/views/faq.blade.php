...
@section('top_bar')
  <nav class="navbar navbar-default navbar-static-top bg-primary" style="background-color: blue">
    ...
    <div class="nav-bar bg-primary" style="background-color: blue">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                @guest
                  <li><a href="{{ route('login') }}" title="Login" style="background-color: blue" >Login</a></li>
                  <li><a href="{{ route('register') }}" title="Register" style="background-color: blue">Register</a></li>
                @else
                  <li class="dropdown">
                  ...
                  <li><a href="{{ route('faq.get') }}" style="background-color: blue">FAQ</a></li>
                @endguest
                  @if(!empty($menus))
                    @foreach($menus as $menu)
                      <li><a href="{{ url('pages/'.$menu->slug) }}" style="background-color: blue">{{$menu->name}}</a></li>
                    @endforeach
                  @endif
              </ul>
            </div>
